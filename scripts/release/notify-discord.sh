...
dockerhub_image="https://hub.docker.com/r/tobyshelf/tobyshelf/tags/$NEW_TAG"
ghcr_image="https://github.com/tobyshelf-tools/tobyshelf/pkgs/container/tobyshelf/$NEW_TAG"
