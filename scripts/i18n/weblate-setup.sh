#!/usr/bin/env bash
#
# Weblate Setup Script for Tobyshelf
#
...
#   2. Ensure your GitHub repo (tobyshelf-tools/tobyshelf) is public (required for Libre plan)
#
# Usage:
...
PROJECT_NAME="Tobyshelf"
PROJECT_SLUG="tobyshelf"
PROJECT_WEB="https://github.com/tobyshelf-tools/tobyshelf"

REPO_URL="https://github.com/tobyshelf-tools/tobyshelf.git"
REPO_BRANCH="develop"
