...
> [!NOTE]
> Tobyshelf is the successor of booklore.


Tobyshelf is a self-hosted application for managing your entire book collection in one place.
Organize, read, annotate, sync across devices, and share without relying on third-party services.

[![Release](https://img.shields.io/github/v/release/tobyshelf-tools/tobyshelf?color=818CF8&style=flat-square&logo=github)](https://github.com/tobyshelf-tools/tobyshelf/releases)
[![License](https://img.shields.io/github/license/tobyshelf-tools/tobyshelf?color=fab005&style=flat-square)](LICENSE)
[![Docker Pulls](https://img.shields.io/docker/pulls/tobyshelf/tobyshelf?color=2496ED&style=flat-square&logo=docker&logoColor=white)](https://hub.docker.com/r/tobyshelf/tobyshelf)
...
[Website](https://tobyshelf.org/) | [Documentation](https://tobyshelf.org/docs/getting-started) | [Quick Start](#quick-start) | [Discord](https://discord.gg/9YJ7HB4n8T)

![Tobyshelf Demo](assets/demo.gif)
...
| **BookDrop** | Drop files into a watched folder and Tobyshelf detects, enriches, and queues them for import automatically |
...
> [!TIP]
> For OIDC setup, advanced configuration, or upgrade guides, see the [full documentation](https://tobyshelf.org/docs/getting-started).
...
| Registry | Image |
| --- | --- |
| Docker Hub | `tobyshelf/tobyshelf` |
| GitHub Container Registry | `ghcr.io/tobyshelf-tools/tobyshelf` |
...
# Database
DATABASE_URL=jdbc:mariadb://mariadb:3306/tobyshelf
DB_USER=tobyshelf
DB_PASSWORD=ChangeMe_Tobyshelf_2025!
...
> [!NOTE]
> Upgrading from an existing Booklore container? Keep your current service name, `container_name`, database name/user, ports, and mounted volumes exactly as they are and replace only the `image:` line with `tobyshelf/tobyshelf:<tag>` or `ghcr.io/tobyshelf-tools/tobyshelf:<tag>`.

```yaml
services:
  booklore:
    image: tobyshelf/tobyshelf:v2.2.1
```
...
services:
  tobyshelf:
    image: tobyshelf/tobyshelf:latest
    # Convenience tag:
    # image: tobyshelf/tobyshelf:<release-version>
    # Alternative: ghcr.io/tobyshelf-tools/tobyshelf:<release-version>
    # To build from source instead: comment out 'image' and uncomment below
    # build: .
    container_name: tobyshelf
    environment:
      - USER_ID=${APP_USER_ID}
...
- Helm: [`deploy/helm/tobyshelf/Chart.yaml`](deploy/helm/tobyshelf/Chart.yaml)
...
Drop book files into a watched folder. Tobyshelf picks them up, pulls metadata, and queues them for your review.
...
| Step | What Happens |
| --- | --- |
| 1. Watch | Tobyshelf monitors the BookDrop folder continuously |
...
Set `DISK_TYPE=NETWORK` in your `.env` to run Tobyshelf against a network-mounted file system (NFS, SMB, etc.).
...
| Channel | |
| :--- | :--- |
| Report a bug | [Open an issue](https://github.com/tobyshelf-tools/tobyshelf/issues/new?template=bug_report.yml) |
| Request a feature | [Open an issue](https://github.com/tobyshelf-tools/tobyshelf/issues/new?template=feature_request.yml) |
